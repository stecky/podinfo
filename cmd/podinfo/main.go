...
import (
	...
	"github.com/stecky/podinfo/pkg/api"
	"github.com/stecky/podinfo/pkg/grpc"
	"github.com/stecky/podinfo/pkg/signals"
...
func main() {
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/stecky/podinfo/gh-pages/cuddle_clap.gif")
